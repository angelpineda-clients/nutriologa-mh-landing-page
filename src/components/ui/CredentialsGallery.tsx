            ...
            >
              <span className="credential-card__art">
                {item.kind === "pdf" ? (
                  <span className="credential-card__paper credential-card__paper--pdf" aria-hidden="true">
                    <span className="credential-card__file-badge">{item.extension}</span>
              ...
              <span className="credential-card__meta">
                <span className="credential-card__kicker">
                  {`${labels.counterLabel} ${String(index + 1).padStart(2, "0")} · ${item.extension}`}
                </span>
                <span className="credential-card__title">{item.title}</span>
                {item.note ? <span className="credential-card__note">{item.note}</span> : null}
        ...
        {activeItem ? (
          ...
          >
            ...
            <motion.div
              ...
              aria-describedby={activeItem.note ? descriptionId : undefined}
              initial={
            ...
            >
              ...
              <div className="credentials-gallery__panel-body">
                ...
                <div className="credentials-gallery__details">
                  ...
                  {activeItem.note ? (
                    <p className="credentials-gallery__note" id={descriptionId}>
                      {activeItem.note}
                    </p>
                  ) : null}

                  <p className="credentials-gallery__caption">
                    {`${activeItem.alt} · ${activeItem.extension}`}
                  </p>
